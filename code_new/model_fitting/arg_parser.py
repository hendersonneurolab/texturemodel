...
def get_args():
    ...
    parser.add_argument("--cofactor_cpu",type=nice_str2bool,default=False,
                    help="want to run older version of the fitting that does inverse on CPU? 1 for yes, 0 for no")
