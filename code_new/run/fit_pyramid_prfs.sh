...
export PYTHONPATH=:${ROOT}texturemodel/code_new/${PYTHONPATH}

echo $PYTHONPATH

# go to folder where script is located
cd ${ROOT}texturemodel/code_new/model_fitting
